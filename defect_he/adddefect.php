...
<body>
<fieldset>
<legend>Heuristic Evaluation -> Defect -> Add Defect</legend>
<p></p>
...
VALUES
('$_POST[no]','$_POST[pj12]','$_POST[tp]','HE','$_POST[sp]','$_POST[st]','$cheissue','$_POST[ct]','$_POST[sr]','$chescreen','$cherecommendation','$provect','$cheenvironment','$handle','$impact','$_COOKIE[us]')";
