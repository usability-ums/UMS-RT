...
<fieldset>
<legend>Heuristics Evaluation -> Defect -> Present Defect</legend>
<p></p>
<?php
...
<table>
<input type="hidden" name="hd1" value="<?php printf("%s",$_POST[pid]); ?>">
<tr>
<td>Defect ID</td>
...
<tr>
<td align="center" colspan="2"><br/><input type="submit" name="submit1" value="UPDATE"><td> 
</tr>
</table>
</form>
