...
<body id="dt_example">
<fieldset>
<legend>Heuristics Evaluation -> Defect -> Verify Defect</legend>
<?php
if($_POST[pid] ==""){
?>
<p></p>
<form name="form1" action="vtable.php" method="POST" onsubmit="return docheck1()">
<table>
<tr>
<td>Project Name</td>
...
$sql = "SELECT * FROM defect WHERE project='$_POST[pid]' AND status='Resolved' AND testingtype='HE'";
$result = mysql_query($sql,$con);
...
<?php
if($myrow[status]=="Resolved"){
?>
	<td><a href="verify.php?prop_id=<?php printf("%s",$myrow["id"]); ?>" target="home">Verify</a></td>	
<?php
}else{
?>
