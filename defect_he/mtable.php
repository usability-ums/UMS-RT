...
<body>
<fieldset>
<legend>Heuristics Evaluation -> Defect -> Modify Defect</legend>
<p></p>
<?php
if($_GET[prop_id] !=""){
?>
...
<form name="form" action="mtable.php" ENCTYPE="multipart/form-data" method="POST" onsubmit="return doCheck()">
<table>
<tr>
<td>Defect No</td>
...
<tr>
<td>Screenshot</td>
<td>: <input type="file" name="userfile"/> .jpg & png format only (only upload if you wish to change the images)</td>
</tr>
<tr>
<td>Environment</td>
...
if($chk !=""){
$sql="UPDATE defect SET defecttype='$_POST[tp]',stage1='$_POST[sp]',stage2='$_POST[st]',issue='$cheissue',category='$_POST[ct]',severity='$_POST[sr]',recommendation='$cherecommendation',impact='$impact',screen='$chescreen',file='$provect',environment='$cheenvironment' WHERE id='$_POST[no]'";
...
$sql="UPDATE defect SET defecttype='$_POST[tp]',stage1='$_POST[sp]',stage2='$_POST[st]',issue='$cheissue',category='$_POST[ct]',severity='$_POST[sr]',recommendation='$cherecommendation',impact='$impact',screen='$chescreen',environment='$cheenvironment' WHERE id='$_POST[no]'";
