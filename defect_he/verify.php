...
<body>
<fieldset>
<legend>Heuristics Evaluation -> Defect -> Verification</legend>
<p></p>
<?php
if($_GET[prop_id] !=""){
?>
...
<form name="form" action="verify.php" method="POST" onsubmit="return doCheck()">
<table>
<?php
...
?>
<script type="text/javascript">
alert("'<?php echo $_POST[no] ?>' has been verify successfully!");
</script>
<?php
...
?>
<script type="text/javascript">
document.location.href='vtable.php'
</script>
<?php
}
?>