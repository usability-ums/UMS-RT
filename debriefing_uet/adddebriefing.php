...
<body>
<fieldset>
<legend>User Experience Test -> Debriefing -> Add New Question</legend>
<p></p>
...
<form name="form" action="adddebriefing.php" method="POST" onsubmit="return docheck()">
<table>
<tr>
...
$sql="INSERT INTO debriefing (question)
VALUES
('$_POST[start]')";
...
?>
<script type="text/javascript">
alert("Debriefing question has been added successfully!");
</script>
<?php
