...
<fieldset>
<legend>User Experience Test -> Debriefing -> Assign Question</legend>
<script>
    function doCheck1(){
...
<form name="form" action="assigndebriefing.php" method="POST"" onsubmit="return doCheck1()">
<p></p>
<table border="1" width="70%" bordercolor="black" cellspacing="0" cellpadding="0">
<?php
require("../library/connection.php");

$sql = "SELECT * FROM debriefing";
...
$sql1="INSERT INTO assigndef (no,project)
VALUES
('$language','$_POST[pid]')";
