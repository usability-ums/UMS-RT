...
<body>
<fieldset>
<legend>User Experience Test -> Debriefing -> Modify Question</legend>
<p></p>
<?php
if($_GET[prop_id] !=""){
?>
...
$sql = "SELECT * FROM debriefing WHERE no='$_GET[prop_id]'";
...
$sql="UPDATE debriefing SET question='$_POST[start]' WHERE no='$_POST[id]'";
