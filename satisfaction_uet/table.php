...
<body id="dt_example">
<fieldset>
<legend>User Experience Test -> Satisfaction -> Modify/Delete Question</legend>
...
$sql = "SELECT * FROM satisfaction ORDER BY category ASC";
...
?>
	...
	<td><?php printf("%s",$myrow["category"]); ?></td>
