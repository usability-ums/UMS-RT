...
<fieldset>
<legend>User Experience Test -> Demographic -> Assign Question</legend>
<script>
    function doCheck1(){
...
<form name="form" action="assigndemographic.php" method="POST"" onsubmit="return doCheck1()">
<p></p>
...
$result = mysql_query($sql,$con);
	?>
	<tr><td align="center"><b>Selection</b></td><td><b>Question</b></td><td><b>Answer</b></td></tr>
<?php
...
$string1 = stripcslashes(preg_replace("(\r\n|\n|\r)", "<br />", $string1));
	...
	?><tr><td align="center" width="90"><input type="checkbox" name="<?php printf("%s",$myrow["id"]); ?>" value="<?php printf("%s",$myrow["id"]); ?>"></td><?php
	?><td><?php printf("%s",$string); ?></td><?php
	?><td><?php printf("%s",$string1); ?></td><?php
...
$sql = "SELECT DISTINCT name FROM project WHERE security='unlock' AND method_type='UET' ORDER BY name ASC";
$result = mysql_query($sql,$con);
...
$sql1="INSERT INTO assigndemo (id,project)
VALUES
('$language','$_POST[pid]')";
