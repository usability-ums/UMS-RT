...
<fieldset>
<legend>User Experience Test -> Effectiveness -> Assign Question</legend>
<script>
    function doCheck1(){
...
<form name="form" action="assigneffectiveness.php" method="POST"" onsubmit="return doCheck1()">
<p></p>
<table border="1" width="70%" bordercolor="black" cellspacing="0" cellpadding="0">
<?php
require("../library/connection.php");

$sql = "SELECT * FROM effectiveness ORDER BY no ASC";
...
$sql1="INSERT INTO assigneffectiveness (no,project)
VALUES
('$language','$_POST[pid]')";
