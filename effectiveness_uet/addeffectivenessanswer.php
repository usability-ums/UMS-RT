...
<body>
<fieldset>
<legend>User Experience Test -> Effectiveness -> Set User Score</legend>
<script>
    function doCheck(){
...
<form name="form1" action="addeffectivenessanswer.php" method="POST" onsubmit="return doCheck()">
<p></p>
<table>
<tr>
<td>Project Name</td>
...
$sql = "SELECT DISTINCT project FROM user WHERE effectiveness='No' AND project='$myrow1[name]'";
...
<form name="form2" action="addeffectivenessanswer.php" method="POST" onsubmit="return doCheck2()">
<tr>
<td>Username</td>
...
$sql = "SELECT DISTINCT user FROM user WHERE effectiveness='No' AND project='$_POST[pid]'";
$result = mysql_query($sql,$con);
if ($myrow = mysql_fetch_array($result)){
do {
...
$sql4 = "SELECT * FROM assigneffectiveness WHERE project='$_POST[pj]'";
$result4 = mysql_query($sql4,$con);

if ($myrow4 = mysql_fetch_array($result4)){

?>
<form name="form" action="addeffectivenessanswer.php" method="POST">
...
<?php
	...
	echo "<p style=\"color:red\">No effectiveness question have been assigned!</p>";
}
mysql_close($con);
}else{}
?>
...
$sql2="INSERT INTO answereffectiveness (project,name,task,no,answer)
VALUES
...
$sql="UPDATE user SET effectiveness='Yes' WHERE user='$_POST[username]'";
...
?>
<script type="text/javascript">
alert("For project '<?php echo $_POST[project] ?>', '<?php echo $_POST[username] ?>' effectiveness score has been added successfully!");
document.location.href='addeffectivenessanswer.php'
</script>
<?php
