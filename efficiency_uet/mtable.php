...
<body>
<fieldset>
<legend>User Experience Test -> Efficiency -> Modify Question</legend>
<p></p>
<?php
if($_GET[prop_id] !=""){
?>
...
$sql = "SELECT * FROM efficiency WHERE no='$_GET[prop_id]'";
...
$sql="UPDATE efficiency SET question='$_POST[start]' WHERE no='$_POST[id]'";
...
document.location.href='modifyefficiency.php'
</script>
