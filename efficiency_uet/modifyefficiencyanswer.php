...
<body>
<fieldset>
<legend>User Experience Test -> Efficiency -> Modify User Score</legend>
<script>
    function doCheck(){
...
<form name="form1" action="modifyefficiencyanswer.php" method="POST" onsubmit="return doCheck()">
<p></p>
<table>
<tr>
<td>Project Name</td>
...
$sql = "SELECT DISTINCT project FROM user WHERE efficiency='Yes' AND security='unlock' AND project='$myrow1[name]'";
...
if($_POST[pid] !=""){
?>
<form name="form2" action="modifyefficiencyanswer.php" method="POST" onsubmit="return doCheck2()">
<tr>
<td>Username</td>
...
$sql = "SELECT DISTINCT user FROM user WHERE efficiency='Yes' AND security='unlock' AND project='$_POST[pid]'";
$result = mysql_query($sql,$con);
...
?>
<form name="form" action="modifyefficiencyanswer.php" method="POST">
...
$sql2 = "SELECT * FROM answerefficiency WHERE project='$_POST[pj]' AND name='$_POST[pin]' AND task='$myrow[no]' AND no='$myrow1[no]'";
...
$sql2="UPDATE answerefficiency SET answer='$_POST[$MyName]' WHERE project='$_POST[project]' AND name='$_POST[username]' AND task='$myrow[no]' AND no='$myrow1[no]'";
...
?>
<script type="text/javascript">
alert("For project '<?php echo $_POST[project] ?>', '<?php echo $_POST[username] ?>' efficiency score has been modified successfully!");
document.location.href='modifyefficiencyanswer.php'
</script>
<?php
