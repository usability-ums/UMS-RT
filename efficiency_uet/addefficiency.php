...
<body>
<fieldset>
<legend>User Experience Test -> Efficiency -> Add New Question</legend>
<p></p>
...
<form name="form" action="addefficiency.php" method="POST" onsubmit="return docheck()">
<table>
<tr>
...
$sql="INSERT INTO efficiency (question)
VALUES
('$_POST[start]')";
...
?>
<script type="text/javascript">
alert("Efficiency question has been added successfully!");
</script>
<?php
