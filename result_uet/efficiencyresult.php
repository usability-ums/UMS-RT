...
<body>
<fieldset>
<legend>User Experience Test -> Result -> Efficiency Result</legend>
<script>
    function docheck(){
...
<form name="form1" action="efficiencyresult.php" method="POST" onsubmit="return docheck()">
<p></p>
<table>
<tr>
<td>Project Name</td>
...
$sql = "SELECT name FROM project WHERE method_type='UET' AND type='manual' ORDER BY name ASC";
$result = mysql_query($sql,$con);

if ($myrow = mysql_fetch_array($result)){
do {

$sql1 = "SELECT * FROM user WHERE project='$myrow[name]'";
$result1 = mysql_query($sql1,$con);

if ($myrow1 = mysql_fetch_array($result1)){
?>
	<option value="<?php printf("%s",$myrow1["project"]); ?>"><?php printf("%s",$myrow1["project"]); ?></option>
<?php
}
...
<?php
$percentage=0;
$sql15 = "SELECT COUNT(answer) AS c_points FROM answerefficiency WHERE project='$_POST[pid]' AND name='$myrow13[name]' AND answer='Yes'"; 
$result15 = mysql_query($sql15) or die(mysql_error()); 
$iu = mysql_fetch_array($result15);

$sql16 = "SELECT COUNT(answer) AS c1_points FROM answerefficiency WHERE project='$_POST[pid]' AND name='$myrow13[name]' AND answer='Partial'"; 
$result16 = mysql_query($sql16) or die(mysql_error()); 
$iu1 = mysql_fetch_array($result16);

$sql17 = "SELECT COUNT(answer) AS c2_points FROM answerefficiency WHERE project='$_POST[pid]' AND name='$myrow13[name]'"; 
...
<?php
$sql1 = "SELECT * FROM assignefficiency WHERE project='$_POST[pid]' ORDER BY CAST(no AS UNSIGNED) ASC";
$result1 = mysql_query($sql1,$con);
if ($myrow1 = mysql_fetch_array($result1)){
do {

$sql13 = "SELECT * FROM efficiency WHERE no='$myrow1[no]'";
$result13 = mysql_query($sql13,$con);
...
$sql2 = "SELECT * FROM answerefficiency WHERE project='$_POST[pid]' AND name='$myrow13[name]' AND task='$myrow[no]' AND no='$myrow1[no]'";
...
echo "<p><b>Overall efficiency score for all task is $finalm%</b></p>";
mysql_close($con);
...
<thead>
<tr><th colspan="3">Efficiency</th></tr>
</thead>
<tbody>
<?php
$sql13 = "SELECT DISTINCT name FROM answerefficiency WHERE project='$_POST[pid]'";
...
$sql11 = "SELECT COUNT(answer) AS p_points FROM answerefficiency WHERE project='$_POST[pid]' AND name='$myrow13[name]' AND answer='Partial'"; 
$result11 = mysql_query($sql11) or die(mysql_error()); 
$iu1 = mysql_fetch_array($result11);

$sql12 = "SELECT COUNT(answer) AS n_points FROM answerefficiency WHERE project='$_POST[pid]' AND name='$myrow13[name]' AND answer='No'"; 
$result12 = mysql_query($sql12) or die(mysql_error()); 
$iu2 = mysql_fetch_array($result12);

$sql14 = "SELECT COUNT(answer) AS m_points FROM answerefficiency WHERE project='$_POST[pid]' AND name='$myrow13[name]' AND answer='-'"; 
