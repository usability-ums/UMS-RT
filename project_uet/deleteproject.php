...
<body>
<fieldset>
<legend>User Experience Test -> Project -> Delete UET Project</legend>
<p></p>
<script>
    function docheck(){
...
<?php	
	echo "<p style=\"font-size:15pt;color:red\"><b>WARNING!<br/> All data for this project will be deleted!<br/> But UET user records will remain.</b><br/></p>";
...
$sql="DELETE FROM project WHERE name='$_POST[id]' AND method_type='UET'";
...
$sql="DELETE FROM task WHERE PName='$_POST[id]'";
...
$sql="DELETE FROM assigndef WHERE project='$_POST[id]'";
...
$sql="DELETE FROM assigndemo WHERE project='$_POST[id]'";
...
$sql="DELETE FROM assignsatis WHERE project='$_POST[id]'";
...
$sql="DELETE FROM assigneffectiveness WHERE project='$_POST[id]'";
...
$sql="DELETE FROM assignefficiency WHERE project='$_POST[id]'";
...
$sql="DELETE FROM p_question WHERE title='$_POST[id]'";
...
?>
<script type="text/javascript">
alert("All data of the project name '<?php echo $_POST[id] ?>' has been deleted successfully!");
